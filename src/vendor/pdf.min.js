const _offlineDisabledFetch = () => Promise.reject(new Error("Network fetch disabled in sovereign offline build")); function _OfflineDisabledXHR() { throw new Error("XHR disabled in sovereign offline build"); };
/**
